...
def get_ops_menu_query(dates: List[str]) -> Operation:
    ...
    query.viewer.menus.menuItems.recipe.__fields__('id', 'name', 'categoryValues', 'totalYield', 'recipeInstructions')
    ...
    # query.viewer.menus.menuItems.recipe.recipeTreeComponents.recipeItem.subRecipe.recipeTreeComponents.recipeItem(__alias__='recipeItem').__fields__('preparations')
