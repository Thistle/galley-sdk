...
def get_ops_menu_query(dates: List[str], location_id: str) -> Operation:
    ...
    query.viewer.menus.menuItems.recipe.recipeTreeComponents.recipeItem.subRecipe.ingredientsWithUsages(location_id=location_id).ingredient.__fields__('name', 'externalName')
