...
def get_ops_menu_query(dates: List[str]) -> Operation:
    ...
    query.viewer.menus.menuItems.recipe.recipeTreeComponents.recipeItem.subRecipe.recipeTreeComponents(levels=[1], __alias__='sub_recipe_components').__fields__('quantityUnitValues')
