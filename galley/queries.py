...
def get_ops_menu_query(dates: List[str]) -> Operation:
    ...
    query.viewer.menus.menuItems.recipe.__fields__('id', 'name', 'description', 'categoryValues', 'totalYield', 'recipeInstructions', 'recipeTreeComponents')
    ...
    query.viewer.menus.menuItems.recipe.recipeTreeComponents(levels=[1], __alias__='recipe_tree_components').__fields__('ingredient', 'quantityUnitValues')
    ...
    query.viewer.menus.menuItems.recipe.recipeTreeComponents.recipeItem.subRecipe.recipeTreeComponents(levels=[1], __alias__='sub_recipe_tree_components').__fields__('quantityUnitValues')
    ...
    query.viewer.menus.menuItems.recipe.recipeTreeComponents.recipeItem.subRecipe.recipeTreeComponents.recipeItem(__alias__='sub_recipe_item').__fields__('preparations')
