...
MOCK_RECIPE_ITEMS = [
    ...
    },
    {
        ...
        "locationVendorItems": [
            ...
            "vendorItems": [
                {
                "name": "MANDARINS, SEEDLESS 25#",
                "priority": 0,
                "ingredientListStr": None
                },
                {
                "name": "MANDARINS, SATSUMA CUTIE 4/5# *LOCAL* 235270",
                "priority": 1,
                "ingredientListStr": None
                }
            ]
        ...
        "id": "aW5ncmVkaWVudDoyNDUwMjY=",
        "name": "fresh fruit, clementines, cuties, SEND TO PLATE",
        "externalName": "Seasonal Fruit",
        "categoryValues": [
            {
    ...
    "ingredientsWithUsages": [
                ...
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            {
                                "name": "NGMO HEMP HEARTS, HULLED 33.07#",
                                "priority": 0,
                                "ingredientListStr": None
                            }
                        ]
        ...
        },
        {
            "ingredient": {
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            {
                                "name": "SEEDS, SUNFLOWER HULLED 55.12#",
                                "priority": 0,
                                "ingredientListStr": None
                            }
                        ]
                ...
                "id": "aW5ncmVkaWVudDoyNDQ3ODM=",
                "name": "seeds, sunflower, hulled",
                "externalName": "Sunflower Seeds",
                "categoryValues": []
            },
            "usages": [
                {
                ...
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            {
                                "name": "SPICE, PEPPER BLACK GRD, 3/5#  512194",
                                "priority": 0,
                                "ingredientListStr": None
                            }
                        ]
        ...
        },
        {
            "ingredient": {
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            ...
                            {
                                "name": "SPICE, CHILI POWDER 3/5.5# 512199",
                                "priority": 1,
                                "ingredientListStr": None
                            }
                        ]
                ...
                "id": "aW5ncmVkaWVudDoyNDQ4MDE=",
                "name": "spice, chili powder",
                "externalName": "Chili Powder",
                "categoryValues": []
            },
            "usages": [
                {
        ...
        },
        {
            "ingredient": {
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            {
                                "name": "SPICE, GARLIC POWDER 3/5.25# 512197",
                                "priority": 0,
                                "ingredientListStr": None
                            },
                            {
                ...
                "id": "aW5ncmVkaWVudDoyNDQ4MTc=",
                "name": "spice, garlic powder",
                "externalName": "Garlic Powder",
                "categoryValues": []
            },
            "usages": [
                {
        ...
        },
        {
            "ingredient": {
                "locationVendorItems": [
                    {
                        "vendorItems": [
                            {
                                "name": "Vinegar Champagne Bulk France 21.2#",
                                "priority": 0,
                                "ingredientListStr": None
                            }
                        ]
                ...
                "id": "aW5ncmVkaWVudDoyNDQ5MDY=",
                "name": "vinegar, champagne",
                "externalName": "Champagne Vinegar",
                "categoryValues": []
            },
            "usages": [
                {
